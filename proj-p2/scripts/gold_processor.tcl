...
set design_name gold_processor; # design_name is the name of the module
set clk_period 2.4;  # unit = ns
set posedge 0.0 ;
...
## set multiplier implementation type
## set_implementation str ALU.ALU_MUL32
...
current_design alu;
report_resources > reports/alu.resources;
